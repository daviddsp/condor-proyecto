 ...
 * @property Leccion[] $leccions1
 * @property Evaluaciones[] $evaluaciones
 * @property Evaluaciones[] $evaluaciones1
 */
class Tema extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'leccions1' => array(self::HAS_MANY, 'Leccion', 'nombre'),
			'evaluaciones' => array(self::HAS_MANY, 'Evaluaciones', 'id_tema'),
			'evaluaciones1' => array(self::HAS_MANY, 'Evaluaciones', 'nombre'),
		);
	}
