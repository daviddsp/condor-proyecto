 ...
 * @property Temas[] $temases1
 * @property Movimientos[] $movimientoses
 * @property Movimientos[] $movimientoses1
 */
class Usuarios extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'temases1' => array(self::HAS_MANY, 'Temas', 'login'),
			'movimientoses' => array(self::HAS_MANY, 'Movimientos', 'id_usuario'),
			'movimientoses1' => array(self::HAS_MANY, 'Movimientos', 'login'),
		);
	}
